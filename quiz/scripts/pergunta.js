...
spanMateriaEscolhida.innerText = materiaEscolhida == 'C' ? 'Ciências' :
                                 materiaEscolhida == 'G' ? 'Geografia' :
                                 materiaEscolhida == 'H' ? 'História' :
                                 materiaEscolhida == 'I' ? 'Inglês' :
                                 materiaEscolhida == 'M' ? 'Matemática' :
                                 materiaEscolhida == 'P' ? 'Português' :
                                 'Variados';

fetch('C:\Web ideias\narutex216bits.github.io\perguntas.json')
